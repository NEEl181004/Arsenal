...
import { ShieldAlert, Eye, EyeOff, Loader2, UserPlus, Shield } from "lucide-react";
            ...
            <div className="hidden lg:flex w-[52%] xl:w-[55%] flex-col justify-between p-16 xl:p-20 relative overflow-hidden bg-[#080808] border-r border-white/[0.04]">
                ...
                <div className="relative z-10">
                    ...
                    <div className="inline-flex items-center gap-3 bg-primary/10 border border-primary/20 px-4 py-1.5 mb-10">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.25em] text-primary">REQUEST CLEARANCE</span>
                    </div>
                    ...
                    <p className="mt-8 text-sm text-white/30 font-light leading-relaxed max-w-sm">
                        Register your operator identity to gain access to the Arsenal tactical intelligence platform.
                    </p>
                </div>
                ...
                <div className="w-full max-w-[400px] space-y-10 relative z-10">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-2 text-primary mb-4">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.3em]">New Operator Registration</span>
                        </div>
                        <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-white uppercase">
                            Request<br className="sm:hidden" /> Access
                        </h2>
                        <p className="text-white/30 text-sm font-light">
                            Create your operator identity to access the Arsenal platform.
                        </p>
                    </div>
